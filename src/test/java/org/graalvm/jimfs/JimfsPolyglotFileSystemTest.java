...
public class JimfsPolyglotFileSystemTest {

    private FileSystem fs;
    private Path workDir;
    private Path newWorkDir;
    private Path existingAbsolute;
    private Path existingRelative;

    public JimfsPolyglotFileSystemTest() {
    }
    ...
    public void setUp() throws IOException {
        ...
        builder.setAttributeViews("basic", "owner", "posix");
        builder.setDefaultAttributeValue("posix:group", "users");
        builder.setDefaultAttributeValue("owner:owner", "tom");
        fs = JimfsPolyglotFileSystem.create(builder.build());
        workDir = fs.parsePath("/cwd");
        newWorkDir = fs.parsePath("/newcwd");
        fs.createDirectory(newWorkDir);
